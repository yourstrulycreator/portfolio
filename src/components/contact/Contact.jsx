            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">mike.creator@icloud.com</span>
                        
                        <a href="mailto:mike.creator@icloud.com" className="contact__button">
                            Write Me{" "} 
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">mike.nwankwo@outlook.com</span>
                        
                        <a href="mailto:mike.nwankwo@outlook.com" className="contact__button">
                            Write Me{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+2348174947144</span>
                        
                        <a href="tel:+2348174947144" className="contact__button">
                            Call Me{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
